...
public class pii2 {
	WebDriver  driver;
	WebDriverWait wait;
	@Given("i want to enter as admin")
	public void i_want_to_enter_as_admin() {
	...
	@Given("i want to add a product")
	public void i_want_to_add_a_product() {
	...
	@Then("i want to make a successful payment")
	public void i_want_to_make_a_successful_payment() {
		 ...
		 wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("body > div.col-md-12.col-sm-12.col-xs-12 > form > div.autocomplete")));
		 WebElement search=driver.findElement(By.name("products"));
			...
			wait=new WebDriverWait(driver,10);
			 wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("#header > div.header-middle > div > div > div.col-sm-8 > div > a:nth-child(2)")));
